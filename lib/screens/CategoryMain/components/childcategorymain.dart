...
class ChildCategorymain extends StatefulWidget {
  int quantitys;
  ...
  @override
  _ChildCategorymainState createState() => _ChildCategorymainState();
}

class _ChildCategorymainState extends State<ChildCategorymain> {
  @override
