...
class Childlisthighlight extends StatefulWidget {
  int quantitys;
  ...
  @override
  _ChildlisthighlightState createState() => _ChildlisthighlightState();
}

class _ChildlisthighlightState extends State<Childlisthighlight> {
  @override
