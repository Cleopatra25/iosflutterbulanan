...
class Childlistproduct extends StatefulWidget {
  int quantitys;
  ...
  @override
  _ChildlistproductState createState() => _ChildlistproductState();
}

class _ChildlistproductState extends State<Childlistproduct> {
  @override
